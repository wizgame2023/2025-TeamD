...
namespace basecross {
	...
	public:
		...
		*/
		...
		Effekseer::Handle PlayEffect(const wstring& Key, const bsm::Vec3& Emitter, const float freme);
		...
		void SetRotation(Effekseer::Handle handle, const bsm::Vec3& Location, const float angle);
